...
def update_homepage() -> None:
    ...
    <meta name="robots" content="index,follow,max-image-preview:large" />
    <link href="assets/css/home-fixes.css?v=20260820-mobile-circle-3" rel="stylesheet" />"""
    ...
    text = text.replace('    <link href="assets/css/home-fixes.css?v=20260820-mobile-circle-3" rel="stylesheet" />\n', '')
    text = text.replace('    <link href="assets/css/style.css" rel="stylesheet" />', '    <link href="assets/css/style.css" rel="stylesheet" />\n    <link href="assets/css/home-fixes.css?v=20260820-mobile-circle-3" rel="stylesheet" />', 1)
